...
/**
 Expeción generada por algunas operaciones del TAD Consultorio
 debido a que el médico al que se intenta acceder no está dado
 de alta.
 */
DECLARA_EXCEPCION(MedicoNoExiste);

/**
 Excepción generada por la operación pideConsulta del TAD
 Consultorio debido a que la fecha con la que se intenta
 pedir cita ya está reservada.
*/
DECLARA_EXCEPCION(FechaOcupada);

/**
 Excepción generada por algunas operaciones del TAD Consultorio
 debido a que un médico no tenga pacientes.
 */
